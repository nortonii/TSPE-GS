...
def evaluate_mesh(dataset : ModelParams, iteration : int, DTU_PATH : str):
    ...
    mesh_file = os.path.join(dataset.model_path, "recon_all.ply")
    print("load")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--DTU', type=str,  default='/home/gyh/dataset/DTU-origin/', help='path to the GT DTU point clouds')
